...
const (
	OptionsObjTypeOne OptionsObjType = "1"
...
func CreateOptionsObjOne(one One) OptionsObj {
	typ := OptionsObjTypeOne
...
func (u *OptionsObj) UnmarshalJSON(data []byte) error {
	...
	u.Type = best.Type.(OptionsObjType)
	switch best.Type {
	case OptionsObjTypeOne:
		u.One = best.Value.(*One)
		return nil
	case OptionsObjTypeStr:
...
func (s *SelectAttribute) GetOptions() []*OptionsObj {
	if s == nil {
		return nil
	}
	return s.Options
