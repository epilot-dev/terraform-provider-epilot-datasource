...
const (
	CurrencyTypeCurrencyAttribute1 CurrencyType = "CurrencyAttribute_1"
)
...
func CreateCurrencyCurrencyAttribute1(currencyAttribute1 CurrencyAttribute1) Currency {
	typ := CurrencyTypeCurrencyAttribute1
...
func (u *Currency) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &currencyAttribute1, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  CurrencyTypeCurrencyAttribute1,
	...
	switch best.Type {
	case CurrencyTypeCurrencyAttribute1:
