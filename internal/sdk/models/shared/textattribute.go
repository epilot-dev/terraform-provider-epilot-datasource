...
func (u *Rows) UnmarshalJSON(data []byte) error {
	...
	u.Type = best.Type.(RowsType)
	switch best.Type {
	case RowsTypeInteger:
...
func (t *TextAttribute) GetConstraints() *Constraints {
	if t == nil {
		return nil
	}
...
func (t *TextAttribute) GetInfoHelpers() *InfoHelpers {
	if t == nil {
		return nil
	}
...
func (t *TextAttribute) GetExplicitSearchable() *bool {
	if t == nil {
		return nil
	}
...
func (t *TextAttribute) GetExcludeFromSearch() *bool {
	if t == nil {
		return nil
	}
...
func (t *TextAttribute) GetEditMode() *EditMode {
	if t == nil {
		return nil
	}
	return t.EditMode
...
func (t *TextAttribute) GetEditModeConfig() *EditModeConfig {
	if t == nil {
		return nil
	}
