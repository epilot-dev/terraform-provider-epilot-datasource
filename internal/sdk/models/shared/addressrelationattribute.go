...
func (a *AddressRelationAttribute) GetExplicitSearchable() *bool {
	if a == nil {
		return nil
	}
...
func (a *AddressRelationAttribute) GetExcludeFromSearch() *bool {
	if a == nil {
		return nil
	}
...
func (a *AddressRelationAttribute) GetEditMode() *EditMode {
	if a == nil {
		return nil
	}
	return a.EditMode
...
func (a *AddressRelationAttribute) GetEditModeConfig() *EditModeConfig {
	if a == nil {
		return nil
	}
